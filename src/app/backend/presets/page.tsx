...
export default function PresetsAdmin() {
  ...
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-2xl font-bold mb-6">Game Presets Management</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  className="bg-slate-100"
                />
                <p className="text-xs text-gray-50 mt-1">If left empty, the value will be used as the label.</p>
              </div>
            </CardContent>
            <CardFooter>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Current Presets</CardTitle>
          </CardHeader>
          <CardContent>
            {loading ? (
          ...
          <CardFooter>
            <Button variant="outline" className="w-full" onClick={fetchPresets} disabled={loading || isSubmitting}>
              {loading ? (
                <>
                  <ImSpinner8 className="mr-2 h-4 w-4 animate-spin" />
                  Refreshing...
