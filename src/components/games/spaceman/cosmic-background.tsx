...
export function CosmicBackground() {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      gradient.addColorStop(0, "rgba(88, 28, 135, 0.8)")
      ...
      cosmicGradient.addColorStop(0, "rgba(167, 139, 250, 0.1)")
      cosmicGradient.addColorStop(0.5, "rgba(139, 92, 246, 0.05)")
      cosmicGradient.addColorStop(1, "rgba(0, 0, 0, 0)")
