...
// //   //     showResults
// //   //   ) {
// //   //     saveCrashDataToFirebase()
// //   //   }
// //   // }, [winRate, expectedValue, profit, demoMode, showResults])


// //   // Add a function to save crash data to Firebase after the calculateStatistics function
// //   function saveCrashDataToFirebase() {
...
// //         // addDoc(collection(db, "crashHistory"), crashData)
// //         //   .then(() => console.log("Crash data saved to Firebase"))
// //         //   .catch((error) => console.error("Error saving crash data:", error))
// //       } catch (error) {
// //         console.error("Error preparing crash data:", error)
// //       }
// //     }
// //   }

// //   // Modify the cashOut function to save data when user cashes out
// //   function cashOut1() {
...
// //       // Save data to Firebase after a short delay to ensure statistics are calculated
...
// //       // Inside the if (newMultiplier >= crashPointRef.current && isRunning) block,
// //       // after the calculateStatistics() call and before the return statement, add:
// //       setTimeout(() => saveCrashDataToFirebase(), 500)
