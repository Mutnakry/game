...
// //   const [selectedPreset, setSelectedPreset] = useState<number | null>(null) // Don't select any preset by default
// //   const [isRunning, setIsRunning] = useState(false)
// //   const [hasCrashed, setHasCrashed] = useState(false)
// //   const [isBetting, setIsBetting] = useState(false)
// //   const [multiplier, setMultiplier] = useState(1.0)
// //   const [profit, setProfit] = useState<number | null>(null)
// //   const [autoStart, setAutoStart] = useState(false) // Changed default to false
...
// //   const [demoMode, setDemoMode] = useState(true) // New state for demo mode
// //   const [isStarting, setIsStarting] = useState(false) // New state for start delay
...
// //       // Calculate statistics based on the current crash point
// //       calculateStatistics()
...
// //       const win = simCrashPoint >= cashoutMultiplier
// //       const profit = win ? betAmount * (cashoutMultiplier - 1) : -betAmount
...
// //         cashOut()
// //       } else {
// //         // If not betting, still show results
// //         calculateStatistics()
// //         setShowResults(true)
// //       }
...
// //       // No automatic restart - user must click "Play Again"
...
// //             <div className="text-white text-2xl font-bold animate-pulse">Starting in 2 seconds...</div>
// //           </div>
// //         )}
...
// // Define a type for the preset data
// type Preset = {
//   value: number
//   label: string
// }
...
//   const [demoMode, setDemoMode] = useState(true) // New state for demo mode
//   const [isStarting, setIsStarting] = useState(false) // New state for start delay
//   const [presets, setPresets] = useState<Preset[]>([]) // State for presets
//   const [isLoadingPresets, setIsLoadingPresets] = useState(true) // Loading state for presets
...
//   // Replace the fetchPresets function with this updated version that uses the API route
...
//   // Alternative: If you want to fetch directly from Firebase without an API route
//   // Uncomment this code and comment out the above fetchPresets function
//   // /*
//   // const fetchPresets = async () => {
//   //   setIsLoadingPresets(true)
//   //   try {
//   //     // Import the client-side function
//   //     const { fetchPresetsFromFirebase } = await import("@/app/api/game-presets/client-side")
      
//   //     // Fetch presets directly from Firebase
//   //     const data = await fetchPresetsFromFirebase()
      
//   //     // Set the presets
//   //     setPresets(data)
//   //   } catch (error) {
//   //     console.error("Error fetching presets:", error)
//   //     // Fallback to default presets if Firebase fetch fails
//   //     setPresets([
//   //       { value: 10.0, label: "10.00" },
//   //       { value: 20.0, label: "20.00" },
//   //       { value: 50.0, label: "50.00" },
