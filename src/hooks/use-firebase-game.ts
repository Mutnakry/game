...
//       if (!result.success) {
//         throw new Error(result.message || "Failed to save game result")
//       }
...
//   const getRecentResults = async (resultsLimit = 10) => {
//     setIsLoading(true)
//     setError(null)

//     try {
//       const q = query(collection(db, "gameResults"), orderBy("createdAt", "desc"), limit(resultsLimit))
